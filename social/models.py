...
class Notification(models.Model):
	...
	to_user = models.ForeignKey(User, related_name='notification_to', on_delete=models.CASECADE, null=True)
	from_user = models.ForeignKey(User, related_name='notification_from', on_delete=models.CASECADE, null=True)
