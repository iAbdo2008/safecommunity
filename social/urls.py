...
urlpatterns = [
	...
	path('', FPostListView.as_view(), name='fpost-list'),
	path('post/<int:pk>', FPostDetailView.as_view(), name='fpost-detail'),
	path('post/edit/<int:pk>', FPostEditView.as_view(), name='fpost-edit'),
	path('post/delete/<int:pk>', FPostDeleteView.as_view(), name='fpost-delete'),
	path('post/<int:post_pk>/comment/delete/<int:pk>', CommentDeleteView.as_view(), name='fcomment-delete'),
]
