...
urlpatterns = [
	...
	path('', FPostListView.as_view(), name='post-list'),
	path('post/<int:pk>', FPostDetailView.as_view(), name='post-detail'),
	path('post/edit/<int:pk>', FPostEditView.as_view(), name='post-edit'),
	path('post/delete/<int:pk>', FPostDeleteView.as_view(), name='post-delete'),
	path('post/<int:post_pk>/comment/delete/<int:pk>', CommentDeleteView.as_view(), name='comment-delete'),
]
